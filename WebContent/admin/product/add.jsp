...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			$(function(){
				$.post(
					"${pageContext.request.contextPath}/adminServlet?method=findAllCategory",
					 //2:编写回调函数获得响应数据
					 function(data){
						 //[{},{},{}]
						 //3:拼接多个<option value=""></option>
						 var content = ""; 
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminAddServlet" method="post" enctype="multipart/form-data">
			&nbsp;
