...
<script type="text/javascript">
			...
			function findOrderInfoByOid(oid){
				...
				$.post(
					   "${pageContext.request.contextPath }/adminServlet?method=findOrderInfoByOid",
						{"oid":oid},
						//编写回调函数,获得数据
						function(data){
							debugger
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${ordersBeans }" var="ordersList"
								varStatus="vs">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%">${ordersList.oid }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%">${ordersList.total }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%">${ordersList.name }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%">${ordersList.state==0?"未付款":"已付款" }
									</td>
									<td align="center" style="HEIGHT: 22px"><input
										type="button" value="订单详情" class="clickedElement"
										onclick="findOrderInfoByOid('${ordersList.oid}')"/>
									</td>
								</tr>
							</c:forEach>
						</table>
