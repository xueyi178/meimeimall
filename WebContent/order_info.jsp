...
<body>
	...
	<div class="container">
		<div class="row">
			<div style="margin: 0 auto; margin-top: 10px; width: 950px;">
				...
				<table class="table table-bordered">
					<tbody>
						<tr class="warning">
							<th colspan="5">订单编号:${ordersBean.oid }</th>
						</tr>
						<tr class="warning">
							<th>图片</th>
							<th>商品</th>
						...
						<c:forEach items="${ordersBean.orderitemBeans }" var="order">
						<tr class="active">
							<td width="60" width="40%">
							<input type="hidden" name="id" value="22"> 
							<img src="${pageContext.request.contextPath }/${order.productBean.pimage}" width="70" height="60"></td>
							<td width="30%"><a target="_blank"> ${order.productBean.pname}</a></td>
							<td width="20%">￥${order.productBean.shop_price}</td>
			...
			<div style="text-align: right; margin-right: 120px;">
				商品金额: <strong style="color: #ff6600;">￥${ordersBean.total }元</strong>
			</div>
		...
		<div>
			<hr />
			<form id="orderForm" class="form-horizontal" action="${pageContext.request.contextPath }/prdocutServlet" method="post" style="margin-top: 5px; margin-left: 150px;">
				<!-- method的名字通过表单域来提交 -->
				<input type="hidden" name="method" value="confirmOrder">
				<!-- 传递订单ID -->
				<input type="hidden" name="oid" value="${ordersBean.oid }">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputPassword3"
							placeholder="请输收货人" value="${userBean.name }" name="name">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="confirmpwd"
							placeholder="请输入联系方式" value="${userBean.telephone }" name="telephone">
					</div>
				</div>
